...
*/
 (function(w) {
    ...
    w(function() {
        ...
        IMG = w('<img alt="" />')[0];
        g = w('<div id="lbImage" />').append(IMG).appendTo(a).append(p = w('<div style="position: absolute;left:0;top:0;" />').append([I = w('<a id="lbPrevLink" href="#" />').click(B)[0], d = w('<a id="lbNextLink" href="#" />').click(e)[0]])[0])[0];
    ...
    function i() {
        ...
        //var __W = k.width > 1000 ? 100 : k.width;
        w(p).width(__W);
        w([p, I, d]).height(__H);
        w(A).html(f[F][1] || "");
