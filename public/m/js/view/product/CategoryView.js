define([
    ...
    'template',
    'backbone',
    'text!../../../template/product/category.html',
...
function($, template, Backbone, tpl,model){
    ...
    return Backbone.View.extend({
        ...
        initialize: function(obj){
            this.model = new this.model('product');
            this.model.fetch({
        ...
        render: function(context) {
            ...
            if(!Saturn.isCurrentView("product","category")){
                return false;
            }
            ...
            _.each(this.model.get('data'),function(value, key,list){
                $('#js_categoryListContent input[type=checkbox][name=status]').eq(key).prop("checked",value.status);
            })
