...
<html lang="zh">
    <head>
        ...
        <script src="{{asset('themes/sspai2014/_res/js/main.js')}}"></script>
        <link rel="stylesheet" href="{{asset('themes/sspai2014/_res/css/style.css')}}" />
        <link rel="stylesheet" href="{{asset('themes/sspai2014/_res/css/typo.css')}}" />
    ...
    <body>
        <!-- 頭部 R-HEADER -->
        @include('sspai2014.include.header')
        ...
        <!--尾部 R-FOOTER -->
        @include('sspai2014.include.footer')
    </body>
</html>