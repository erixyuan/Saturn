    ...
    return Backbone.View.extend({
        ...
        initialize: function(obj){
            ...
            if (obj == undefined) {
                ...
                var status = this.status = obj.status == undefined ? 'publish' : obj.status;
            ...
            Saturn.articleList = this.model = new this.model(status,page,obj.keyword,obj.category,obj.author);  // 3.初始化模型
        ...
        render: function() {
            ...
            _.each(this.model.get('data'),function(value,key,list){
                ...
                value.url = Saturn.cmsPath+value.id;
            })
